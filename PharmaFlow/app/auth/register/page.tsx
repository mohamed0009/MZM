...
export const metadata: Metadata = {
  title: "PharmaSys - Inscription",
  description: "Créez votre compte PharmaSys",
}
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-pharma-primary to-pharma-secondary items-center justify-center p-12">
        <div className="max-w-lg">
          <div className="text-white">
            ...
            <h1 className="text-4xl font-bold mb-6">Rejoignez PharmaSys</h1>
            <p className="text-lg mb-8 opacity-90">
              Créez votre compte pour accéder à toutes les fonctionnalités de notre système de gestion de pharmacie.
            </p>
            
            <div className="bg-white/10 rounded-lg p-6">
              <h2 className="text-xl font-medium mb-4">Avantages de l'inscription</h2>
              <ul className="space-y-2">
                <li className="flex items-center">
                  ...
                  Accès à tous les modules du système
                </li>
                <li className="flex items-center">
                  <div className="mr-2 bg-white/20 p-1 rounded-full">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-4 w-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
