      ...
      <CardHeader className="space-y-2 text-center">
        <div className="flex justify-center">
          <div className="relative w-14 h-14">
            <div className="absolute inset-0 bg-emerald-500 rounded-full animate-pulse opacity-60"></div>
            <div className="relative flex items-center justify-center w-full h-full bg-emerald-500 rounded-full">
              ...
              >
                <path 
                  ...
                  stroke="currentColor" 
                  strokeWidth="1.5"
                  className="heartbeat-line text-emerald-200"
                />
              </svg>
            </div>
          </div>
        ...
        <CardDescription>Entrez votre adresse email pour recevoir un lien de récupération</CardDescription>
      </CardHeader>
      <CardContent>
        {success ? (
          <Alert className="bg-green-50 text-green-800 border-green-200">
            <AlertDescription>
              Si un compte existe avec cette adresse email, vous recevrez un lien de récupération dans quelques
              minutes.
            </AlertDescription>
          </Alert>
        ) : (
